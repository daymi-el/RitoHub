...
import type {Region} from "@zqz979/league-api-wrapper";
import {
    Dialog,
    DialogClose,
    DialogContent,
...
const REGIONS: Region[] = ["AMERICAS", "ASIA", "EUROPE", "SEA"];
...
export function AddAccountDialog() {
    ...
    const processAccount = async (
        ...
        const riotData = await getRiotAccount(gameName, tagLine, region);
        const leagueData = await getLeagueAccountData(
            riotData.puuid,
            "EUW1"
        );
    ...
    const onSingleSubmit = async (values: SingleFormValues) => {
        ...
        try {
            ...
            const newAccount = await processAccount(
                values.username,
                gameName,
                tagLine,
                values.password,
